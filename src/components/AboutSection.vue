    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">I studied Computer Engineering at Mehmet Akif Ersoy University, where I discovered my passion for software and design. 
                    I'm always eager to learn, improve, and take on new creative challenges. 
                    In my free time, I enjoy exploring different cultures and working on personal projects.
                </p>
            </div>
        </div>
    </section>
